...
public class CellService {
    ...
    public static List<Command> isReadyToExplode(Cell cell) {
        int cX = cell.getX();
        int cY = cell.getY();

        List<Command> indices = new ArrayList<>();
